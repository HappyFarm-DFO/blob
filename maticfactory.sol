...
contract Collections{
    ...
    function collection(uint256 id)external view returns(address,uint256){

        return (collections[id],collections.length);
    }
}
 ...
 contract CollectionsFactoryMatic {
    ...
    address public CypherCardShop=0x1Cf58F20D8d6D3814A21A6fff6a17F173eC966C8;
    address public Tracker=0x1Cf58F20D8d6D3814A21A6fff6a17F173eC966C8;
    address public Collection=0x1Cf58F20D8d6D3814A21A6fff6a17F173eC966C8;
    ...
    function createCollection(string memory uri) public returns(bool) {
        ERC1155 collection=new ERC1155(uri);
        Collections(Collection).addCollection(address(collection));
...
contract tracker {
    ...
    function setDev(address payable owner)payable public {
        require(msg.sender==CypherVault,"permission required");
        Dev=owner;
    }
...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    address public CypherShop = 0x1Cf58F20D8d6D3814A21A6fff6a17F173eC966C8;
    address public Tracker = 0x364B1CB7264fd74f7303276672198Ae3465A5D3f;
...
contract ICypherCardShop1155{
    ...
    function setIncrement(uint256 price) external{
       require(msg.sender==CypherVault,"permission required");
       increment=price;
    }
